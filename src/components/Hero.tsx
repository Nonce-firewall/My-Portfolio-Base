        ...
        <div className="space-y-8 animate-slide-up">
          ...
          <div className="flex flex-row sm:flex-row gap-4 justify-center items-center">
            <button
              ...
              className="py-2 px-4 bg-indigo-600 text-white hover:bg-gray-800 transition-all duration-300 rounded-md transform hover:scale-105 active:scale-95 hover:shadow-lg animate-slide-up"
            >
              View My Work
            </button>
            <button
              onClick={() => navigate('/contact')}
              className="py-2 px-4 bg-blue-600 text-white hover:bg-orange-700 hover:text-white transition-all duration-300 rounded-md transform hover:scale-105 active:scale-95 hover:shadow-lg animate-slide-up"
            >
              Get In Touch
            </button>
          </div>
